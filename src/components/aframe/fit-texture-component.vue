...
export default {
    methods : {
        createCompoenent: function () {
            console.log("createCompoenent")
            // create AFRAME component fit-texture
            if (process.browser) {
        ...
        registerComponent: function () {
            console.log("registerComponent: fit-texture")
            AFRAME.registerComponent('fit-texture', {
                 ...
                 */
                init: function () { console.log("fix-texture init()") },
